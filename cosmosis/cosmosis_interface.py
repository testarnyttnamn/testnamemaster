...
def setup(options):
    ...
    info = config_dict['Cosmosis']['likelihood']['Euclid']
    data = info['data']
    ...
    cloe_cosmo.cosmo_dic['observables_specifications'] = observables['specifications']
    # Sampling in radius for the sigma(R,z) in Mpc
    # for galaxy clusters
    cloe_cosmo.cosmo_dic['rmin'] = 5
    cloe_cosmo.cosmo_dic['rmax'] = 50
    cloe_cosmo.cosmo_dic['r_samp'] = 100
    cloe_cosmo.cosmo_dic['r_win'] = \
...
def set_fiducial_cosmology(likefinal, info):
    ...
    fid_cosmo.cosmo_dic['rmin'] = 5
    fid_cosmo.cosmo_dic['rmax'] = 50
    fid_cosmo.cosmo_dic['r_samp'] = 100
    fid_cosmo.cosmo_dic['r_win'] = \
        np.linspace(5, 50, 100)
