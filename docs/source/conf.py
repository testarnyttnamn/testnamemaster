...
latex_documents = [
    (master_doc, 'cosmobox.tex', u'cosmobox Documentation',
     u'Euclid IST', 'manual'),
]
...
man_pages = [
    (master_doc, 'cosmobox', u'cosmobox Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cosmobox', u'cosmobox Documentation',
     author, 'cosmobox', 'One line description of project.',
     'Miscellaneous'),
]
