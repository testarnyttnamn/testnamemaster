...
from cloe.auxiliary.logger import log_debug, log_info
import cobaya.run
...
class LikelihoodUI:
    ...
    def __init__(self, user_config_file=None, defaults_config_file=None,
        ...
        user_config_file: str, optional
           Name of the :obj:`yaml` configuration file containing the
           user-defined parameters that will determine the behavior
           of CLOE. If not provided, the parameters from the default
           configuration will be used

        defaults_config_file: str, optional
           Name of the yaml configuration file containing the default values
           of the parameters that do not appear in the :obj:`user_config_file`.
           If not provided, the file :obj:`config_default.yaml` in the
           top level of the project will be used

        user_dict: dict, optional
            User-defined dictionary whose keys have higher priority with
            respect to the corresponding keys of :obj:`user_config_file`
    ...
    def run(self):
        ...
        Reads the backend from the input configuration and call the desired
        ...
        Run: tuple
           ...
           the sampler used.
           At present this is the very same thing that is returned by the
           :obj:`run()` method of Cobaya, because Cobaya is the only
           implemented backend
        """
    ...
    def _plot_cobaya(self, settings):
        r"""Obtains plots and files of CLOE observables using Cobaya.
    ...
    def process_chain(self):
        ...
        Reads the output key from the input dictionary and produce a triangle
    ...
    def _check_and_update_likelihood_fields(self, likelihood_sub_dict,
        ...
        likelihood_sub_dict: dict
            Sub dictionary of likelihood
        fields: list of str
            Sub fields of the dictionary
        """
    ...
    def _get_model_path_from_cobaya_dict(self, cobaya_dict):
        ...
        ------
        ValueError
            if the value of the key `'params'` in :obj:`cobaya_dict`
            is not a string
        """
    ...
    def _get_and_check_backend(config):
        """Gets and checks the backend key.
    ...
    def _update_config(orig_config, update_config):
        r"""Updates nested dictionary recursively.
        ...
        update_config: dict or Mapping
           Dictionary with the updates to be applied
