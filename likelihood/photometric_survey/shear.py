...
class Shear:
	...
	.. math::
        ...
        # SJ: We could eventually have a bias parameter for each tomographic bin (also see yaml file)
        # phot_bias = [
    ...
    def GC_window(self, bin_i, bin_j, bin_z_min, bin_z_max, k, z):
        ...
        W_i_G = self.bias(bin_z_min, bin_z_max) * n_z_normalized(z) * self.theory['H'](z)
        return W_i_G
