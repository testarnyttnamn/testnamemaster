# -*- coding: utf-8 -*-
"""MATRIX AND DATA VECTOR MANIPULATOR MODULE

Module for manipulating covariance matrices, data, and theory vectors
"""
...
class Massage:
    r"""Class for manipulating the input for the likelihood evaluation
    ...
    def merge_matrices(matrix1, matrix2):
        ...
        -------
        outMatrix: ndarray
            A matrix in which the number of rows is the sum of the number of
            rows of matrix1 and matrix2, and the number of columns is the sum
            of the number of columns of matrix1 and matrix2.
            ...
            outMatrix[nRows1 + row, nCols1 + col], where nRows1 and nCols1 are
            are the number of rows and columns of matrix1, respectively.
