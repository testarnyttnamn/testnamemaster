...
class Masking:
    ...
    def set_covariance_matrix(self, matrix):
        ...
        matrix: numpy.ndarray
          ...
          It is assumed that the covariance matrix is already unrolled and
          stacked with the same arrangement used for the data and masking
          vectors.
    ...
    def get_masked_covariance_matrix(self):
        ...
        numpy.ndarray
          ...
          It is obtained by removing from the input covariance matrix the rows
          and the columns that correspond to zero-valued entries in the masking
          vector.
          The number of rows (and columns) of the masked covariance matrix is
          given by the number of nonzero entries in the masking vector.
