...
info = {
    'params': {
        ...
        'H0': {'prior': {'min': 40.0, 'max': 100.0},
               'ref': {'dist': 'norm', 'loc': 67.0, 'scale': 1.0},
               'proposal': 0.5,
               'latex': 'H_0'},
        'logA': {'prior': {'min': 1.6, 'max': 7.0},
        ...
        'b1_photo': {'prior': {'min': 0.1, 'max': 3.0},
                     'ref': {'dist': 'norm', 'loc': 1.0997727037892875, 'scale': 0.001},
                     'proposal': 0.001,
                     'latex': 'b_1^{\rm GCph}'},
        'b2_photo': {'prior': {'min': 0.1, 'max': 3.0},
                     'ref': {'dist': 'norm', 'loc': 1.220245876862528, 'scale': 0.001},
                     'proposal': 0.001,
                     'latex': 'b_2^{\rm GCph}'},
        'b3_photo': {'prior': {'min': 0.1, 'max': 3.0},
                     'ref': {'dist': 'norm', 'loc': 1.2723993083933989, 'scale': 0.001},
                     'proposal': 0.001,
                     'latex': 'b_3^{\rm GCph}'},
        'b4_photo': {'prior': {'min': 0.1, 'max': 3.0},
                     'ref': {'dist': 'norm', 'loc': 1.316624471897739, 'scale': 0.001},
                     'proposal': 0.001,
                     'latex': 'b_4^{\rm GCph}'},
        'b5_photo': {'prior': {'min': 0.1, 'max': 3.0},
                     'ref': {'dist': 'norm', 'loc': 1.35812370570578, 'scale': 0.001},
                     'proposal': 0.001,
                     'latex': 'b_5^{\rm GCph}'},
        'b6_photo': {'prior': {'min': 0.1, 'max': 3.0},
                     'ref': {'dist': 'norm', 'loc': 1.3998214171814918, 'scale': 0.001},
                     'proposal': 0.001,
                     'latex': 'b_6^{\rm GCph}'},
        'b7_photo': {'prior': {'min': 0.1, 'max': 3.0},
                     'ref': {'dist': 'norm', 'loc': 1.4446452851824907, 'scale': 0.001},
                     'proposal': 0.001,
                     'latex': 'b_7^{\rm GCph}'},
        'b8_photo': {'prior': {'min': 0.1, 'max': 3.0},
                     'ref': {'dist': 'norm', 'loc': 1.4964959071110084, 'scale': 0.001},
                     'proposal': 0.001,
                     'latex': 'b_8^{\rm GCph}'},
        'b9_photo': {'prior': {'min': 0.1, 'max': 3.0},
                     'ref': {'dist': 'norm', 'loc': 1.5652475842498528, 'scale': 0.001},
                     'proposal': 0.001,
                     'latex': 'b_9^{\rm GCph}'},
        'b10_photo': {'prior': {'min': 0.1, 'max': 3.0},
                      'ref': {'dist': 'norm', 'loc': 1.7429859437184225, 'scale': 0.001},
                      'proposal': 0.001,
                      'latex': 'b_{10}^{\rm GCph}'},
        'b1_spectro': {'prior': {'min': 0.1, 'max': 3.0},
                      'ref': {'dist': 'norm', 'loc': 1.4614804, 'scale': 0.001},
                      'proposal': 0.001,
                      'latex': 'b_1^{\rm GCsp}'},
        'b2_spectro': {'prior': {'min': 0.1, 'max': 3.0},
                      'ref': {'dist': 'norm', 'loc': 1.6060949, 'scale': 0.001},
                      'proposal': 0.001,
                      'latex': 'b_1^{\rm GCsp}'},
        'b3_spectro': {'prior': {'min': 0.1, 'max': 3.0},
                      'ref': {'dist': 'norm', 'loc': 1.7464790, 'scale': 0.001},
                      'proposal': 0.001,
                      'latex': 'b_1^{\rm GCsp}'},
        'b4_spectro': {'prior': {'min': 0.1, 'max': 3.0},
                      'ref': {'dist': 'norm', 'loc': 1.8988660, 'scale': 0.001},
                      'proposal': 0.001,
                      'latex': 'b_1^{\rm GCsp}'},
        'aia': {'prior': {'min': -5.0, 'max': 5.0},
                'ref': {'dist': 'norm', 'loc': 1.72, 'scale': 0.1},
                'proposal': 0.1,
                'latex': 'A^{\rm IA}'},
        'nia': {'prior': {'min': -5.0, 'max': 5.0},
    ...
    'sampler': {
        'mcmc': {
            'max_tries': 100000}},
    'output': 'chains/chain_GCphot+WL+GCspectro_freenuis',
    'debug': False,
    'timing': True,
    'force': True}
